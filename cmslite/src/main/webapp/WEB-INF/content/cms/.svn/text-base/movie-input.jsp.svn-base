...
<div id="yui-main">
<div class="yui-b">
<h2><s:if test="id == null">创建</s:if><s:else>修改</s:else>电影</h2>
<form id="inputForm" action="movie!save.action" method="post"><input type="hidden" name="id" value="${id}" />
<table class="noborder">
	<tr>
		<td>开始序号:</td>
		<td><input type="text" name="beginMovieNum"  size="40" id="beginMovieNum" value="${beginMovieNum}" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td><input class="button" type="submit" value="提交" /> &nbsp; <input class="button" type="button" value="返回" onclick="history.back()" /></td>
	</tr>
</table>
</form>
</div>
