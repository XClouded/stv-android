package cn.com.supertv.cmslite.entity.account;
...
public class Role extends IdEntity {
	...
	@ManyToMany
	@JoinTable(name = "T_ACCT_ROLE_AUTHORITY", joinColumns = { @JoinColumn(name = "ROLE_ID") }, inverseJoinColumns = { @JoinColumn(name = "AUTHORITY_ID") })
