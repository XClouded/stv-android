    ...
    drop table if exists t_acct_authority;

    drop table if exists t_acct_role;

    drop table if exists t_acct_role_authority;

    drop table if exists t_acct_user;

    drop table if exists t_acct_user_role;
