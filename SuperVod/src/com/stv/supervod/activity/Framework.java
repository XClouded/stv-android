...
//				if(checkedId < currFocusId){
//					mViewFliper.setInAnimation(AnimationUtils.loadAnimation(Framework.this,R.anim.push_left_in));
//					mViewFliper.setOutAnimation(AnimationUtils.loadAnimation(Framework.this,R.anim.push_left_out));
//				}else if (checkedId > currFocusId) {
//					mViewFliper.setInAnimation(AnimationUtils.loadAnimation(Framework.this,R.anim.push_right_in));
//					mViewFliper.setOutAnimation(AnimationUtils.loadAnimation(Framework.this,R.anim.push_right_out));					
//				}
				
				switch (position) {
				case 0:
					currFramewrok.startActivity("Homepage", 
							new Intent(Framework.this, Homepage.class),false);
					break;
				case 1:
					currFramewrok.startActivity("Category", 
							new Intent(Framework.this, Category.class),false);
					break;
				case 2:
					currFramewrok.startActivity("Search", 
							new Intent(Framework.this, Search.class),false);
					break;
				case 3:
					currFramewrok.startActivity("MyVod", 
							new Intent(Framework.this, MyVod.class),false);
					break;
				case 4:
					currFramewrok.startActivity("Further", 
							new Intent(Framework.this, Further.class),false);
				default:
					break;
				}
				checkedId=currFocusId;
			}
		});	
	}

	static public void switchActivity(String name, Intent intent) {
		currFramewrok.startActivity( name, intent, true);
	}
	
	private void startActivity( String name, Intent intent, Boolean isInner ){
