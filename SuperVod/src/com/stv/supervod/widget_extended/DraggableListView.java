...
public class DraggableListView extends ListView {
	...
	public DraggableListView(Context context, AttributeSet attrs, int defStyle) {
		...
		if (attrs != null) {
	        ...
	        mItemHeightNormal = res.getDimensionPixelSize(R.dimen.myvod_normal_height);
	        mItemHeightExpanded = mItemHeightNormal*2;//res.getDimensionPixelSize(R.dimen.expanded_height);
	        
	        // 由于有背景图片，所以设置背景无效
	        //dragndropBackgroundColor = 0xc4c459;
	        
			grabberId = R.id.item_img;
			mRemoveMode = 2;
		}
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (mDragListener != null || mDropListener != null) {
			...
			case MotionEvent.ACTION_DOWN:
                ...
                // process delete item
                View deleteView = item.findViewById(R.id.item_iv_state);
                r = mTempRect;       
                deleteView.getDrawingRect(r);
            
                if( x > getWidth() - r.width() ){
                	// do delete fun
                	if( mDeleteListener != null ){
                		mDeleteListener.delete( itemnum );
                		return false;
                	}
                }
				break;
