...
public class HomePageListAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		String poster = (String) children.get(groupPosition).get(childPosition).get(KeyEnum.poster.toString());

		imageDownloader.download(poster, holder.img);

		// System.out.println("========childPosition============="+childPosition+"=====poster====="+poster);
